...
class usuBasicoMain(tk.Frame):
    def __init__(self, master, controlador):
        ...
        try:
            with open(r'C:\Users\evargas\Documents\BAC\IA\ZetaOne2\json\ambientes.json', 'r', encoding='utf-8') as f:
    ...
    def mostrar_funcionalidades(self, acceso_rapido=False):
        ...
        if acceso_rapido:
            funcionalidades_a_mostrar = [f for f in self.funcionalidades if f.get("acceso_directo")]
        ...
        for func in funcionalidades_a_mostrar:
            ...
            btn_acceso = tk.Button(
                card_frame,
                text="acceso rápido" if not func.get("acceso_directo") else "quitar acceso",
                font=("Arial", 8),
                width=15,
                bg="#f9f9f9" if not func.get("acceso_directo") else "#FF3131",
    ...
    def toggle_acceso_directo(self, funcionalidad):
        funcionalidad["acceso_directo"] = not funcionalidad.get("acceso_directo", False)
